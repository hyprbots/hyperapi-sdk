...
async def test_async_parse_include_image_propagates_and_returns_image_url(
    ...
    result = await async_client.parse(tiny_pdf, include_image=True)
...
async def test_async_parse_advanced_mode_propagates_and_returns_structured(
    mock_backend, async_client, tiny_pdf
):
    _seed_presigned(mock_backend)
    submit_route = _seed_submit(mock_backend)
    ...
    result = await async_client.parse(tiny_pdf, mode="advanced")
...
async def test_async_submit_parse_mode_advanced_propagates(mock_backend, async_client, tiny_pdf):
    ...
    await async_client.submit_parse(tiny_pdf, mode="advanced")
